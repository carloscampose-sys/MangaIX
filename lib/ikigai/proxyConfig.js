...
/**
 * Construye los parámetros de URL para la API de Ikigai
 *
...
export function buildApiParams(params = {}) {
  ...
  // Siempre incluir nsfw=true (requerido por la API)
  ...
  // La API acepta múltiples parámetros 'genre' para filtrar por varios géneros
  ...
  // Filtros de tipo (múltiples tipos pueden enviarse)
  ...
  // Opción de ordenamiento (opcional)
  if (sortBy) {
